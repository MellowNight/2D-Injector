...
namespace Hooks
{
    struct JmpRipCode
    {
        ...
        JmpRipCode(uintptr_t hook_address, uintptr_t jmp_target)
        {
            ...
            original_bytes = (uint8_t*)VirtualAlloc(NULL, orig_bytes_size, MEM_RESERVE | MEM_COMMIT, PAGE_READWRITE);
            ...
            hook_code = (uint8_t*)VirtualAlloc(NULL, hook_size, MEM_RESERVE | MEM_COMMIT, PAGE_READWRITE);
